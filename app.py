...
st.set_page_config(page_title="Smart Health Diary V2.3", page_icon="🥗", layout="wide")
...
if log_data.empty or 'Date' not in log_data.columns:
    ...
    # 2. ให้เลือกว่าจะดูรวมทั้งเดือน หรือจะเจาะจงดูรายวัน
